...
export default function Football() {
  ...
  const sportDetails = {
    sport: 'Football',
    description: "Join our dynamic football program designed for players of all levels. Our professional coaches focus on developing technical skills, tactical understanding, and physical fitness. Train on our world-class facilities and take your game to the next level.",
    coaches: [
      {
