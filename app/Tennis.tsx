...
export default function Tennis() {
  ...
  const sportDetails = {
    sport: "Tennis",
    description:
      "Experience tennis excellence at our state-of-the-art facility. Our professional coaches provide personalized training for all skill levels, focusing on technique, footwork, and match strategy. Join us to improve your game and enjoy this dynamic sport.",
    coaches: [
      {
        name: "Rajesh Verma",
