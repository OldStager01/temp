...
export default function Badminton() {
  ...
  const sportDetails = {
    sport: "Badminton",
    description:
      "Experience badminton at its finest in our state-of-the-art courts. Our professional coaches offer personalized training for all skill levels, from beginners to advanced players. With video analysis and modern equipment, we help you perfect your game.",
    coaches: [
      {
        name: "John Smith",
