...
export default function Swimming() {
  ...
  const sportDetails = {
    sport: 'Swimming',
    description: "Dive into excellence with our comprehensive swimming programs. From beginners learning water safety to advanced swimmers perfecting their strokes, our heated pool and expert instructors ensure a safe and effective learning environment for all ages.",
    coaches: [
      {
        name: 'David Wilson',
