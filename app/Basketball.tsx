...
export default function Basketball() {
  ...
  const sportDetails = {
    sport: 'Basketball',
    description: "Join our dynamic basketball program led by former professional players. Whether you're a beginner learning the fundamentals or an advanced player honing your skills, our comprehensive training covers dribbling, shooting, defense, and game strategy.",
    coaches: [
      {
        name: 'Michael Singh',
