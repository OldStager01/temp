...
export default function Yoga() {
  ...
  const sportDetails = {
    sport: "Yoga",
    description:
      "Transform your mind and body with our holistic yoga programs. Our experienced instructors offer classes for all levels, from gentle beginners' sessions to advanced Ashtanga practice. Focus on flexibility, strength, and mental wellness in our peaceful studio environment.",
    coaches: [
      {
        name: "Anjali Desai",
